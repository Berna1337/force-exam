...
import { Box, VStack, Flex, Container, SimpleGrid, Button, Text, Heading, Stack, HStack } from "@chakra-ui/react";
                  ...
                  <SimpleGrid columns={{ base: 1, md: 2 }} spacing={5}>
                    {actionOptions.map((option) => (
                      ...
                      >
                        ...
                        <Button colorScheme="cyan" variant="solid" size="md" isDisabled>
                          {option.cta}
                        </Button>
                      </Box>
                    ))}
